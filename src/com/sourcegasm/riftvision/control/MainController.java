...
public class MainController {
        ...
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                while (true){
                    ...
                    try {
                        droneController.getDrone().move(roll, pitch, (float) heightController.getHeightMove(), (float) yawController.getYawMove(droneController, sensors));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    try {
    ...
    public HeightController getHeightController(){ return heightController;}
}
